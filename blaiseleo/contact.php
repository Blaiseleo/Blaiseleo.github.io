	...
	<body >
		...
		<div class="jumbotron text-center" style="background: #f4f4f4;" id="home">
			<div class="container header-jumbotron">
				<h1 class="animated pulse">CONTACT US</h1>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="contact-div1 col-md-12 wow fadeInLeft">
						<div style="background: url('img/best2.jpg') no-repeat center; background-size: 100% 100%; background-color: #564740;"></div>
						<h4>Aguh Lewis</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua.</p>
						<p style="font-size: 0.9em; font-weight: bold; margin-top: 2em;">SOFTWARE DEVELOPMENT | LAGOS DEPARTMENT</p>
					</div>
					<div class="contact-div2 col-md-12 wow fadeInLeft">
						<div style="background: url('img/best.jpg') no-repeat center; background-size: 100% 100%; background-color: #564740;"></div>
						<h4>Aguh Lewis</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua.</p>
						<p style="font-size: 0.9em; font-weight: bold; margin-top: 2em;">SOFTWARE DEVELOPMENT | LAGOS DEPARTMENT</p>
				...
				<div class="col-md-6  wow fadeInRight">
					<!-- MAP -->
					<div id="map" style="margin: 3em 0em 5em 0em; height: 35em;"></div>
				</div>
			</div>
		</div>
		<!-- CONTACT CONTENTS -->
