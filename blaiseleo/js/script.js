...
// PLAY JUMBOTRON VIDEO
document.getElementById('playvid').onclick = function () {
  document.getElementById('video').style.display="block";
  document.getElementById('video').play();
  document.getElementById('playvid').style.display="none";
  document.getElementById('jumbotron-content').style.display="none";
  document.getElementById('jumbotron-overlay').style.display="none";
  document.getElementById('home').style.background="white";
};

/* SMOOTH LINK SCROLL TRANSITION */
